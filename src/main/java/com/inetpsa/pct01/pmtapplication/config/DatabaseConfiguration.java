package com.inetpsa.pct01.pmtapplication.config;
...
@Configuration
@EnableJpaRepositories("com.inetpsa.pct01.pmtapplication.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.inetpsa.pct01.pmtapplication.repository.search")
